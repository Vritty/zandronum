/*
    ...
    GLSC2, OpenGL, OpenGL ES loader generated by glad 0.1.34 on Fri Nov 19 08:24:32 2021.

    Language/Generator: C/C++
    Specification: gl
    APIs: gl=2.1, gles1=1.0, gles2=2.0, glsc2=2.0
